                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                          <button @click.prevent="updateInfo" type="submit" class="btn btn-outline-danger">Update</button>
                        </div>
                      </div>
                    </form>
                  </div>
        ...
        methods:{
          ...
          updateProfile(e){
            ...
            if(file['size'] <  2111775){
                ...
                type: 'error',
                title: 'Oops...',
                text: 'Uploaded large File.!',
                footer: '<a href>Image is larger than 2MB </a>'
              })
            }
